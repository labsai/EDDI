...
/**
 * Integration test for the create_api_bot workflow, testing against a <b>running EDDI instance</b>.
 * <p>
 * This is a standalone JUnit test (not {@code @QuarkusTest}) that exercises the full
 * REST API. It validates the resource creation workflow that {@code create_api_bot} produces:
 * <ol>
