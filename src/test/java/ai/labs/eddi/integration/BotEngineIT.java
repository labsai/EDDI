...
class BotEngineIT extends BaseIntegrationIT {
    ...
    void checkWordInputSimpleConversationLog() {
        Response response = sendUserInput(botResourceId.id(), conversationResourceId.id(), "hello", false, false);
    ...
    void checkWordInputCurrentStepOnly() {
        Response response = sendUserInput(botResourceId.id(), conversationResourceId.id(), "hello", false, true);
    ...
    void checkQuickReplyConversationLog() {
        Response response = sendUserInput(botResourceId.id(), conversationResourceId.id(), "question", false, false);
    ...
    private ResourceId setupAndDeployBot(String dictionaryPath, String behaviorPath, String outputPath)
        ...
        String locationDictionary = createBotResource(dictionary, "/regulardictionarystore/regulardictionaries");
