...
class AbstractResourceStoreTest {
    ...
    private AbstractResourceStore<String> store;

    @SuppressWarnings("unchecked")
    @BeforeEach
    void setUp() {
        historizedStore = mock(HistorizedResourceStore.class);
        // Use the constructor that accepts a pre-built HistorizedResourceStore
        store = new AbstractResourceStore<>(historizedStore) {
        };
    }
