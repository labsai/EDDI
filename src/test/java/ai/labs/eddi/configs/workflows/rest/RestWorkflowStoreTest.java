...
class RestWorkflowStoreTest {
    ...
    void setUp() {
        openMocks(this);
        restWorkflowStore = new RestWorkflowStore(
                WorkflowStore, resourceClientLibrary, documentDescriptorStore, jsonSchemaCreator);
    }
    ...
    private void mockSingleReference() throws Exception {
        when(WorkflowStore.getPackageDescriptorsContainingResource(anyString(), eq(false)))
    ...
    class DeletePackageTests {
        ...
        void deletePackage_noCascade() throws Exception {
            restWorkflowStore.deletePackage("pkg1", 1, false, false);
        ...
        void deletePackage_cascade_deletesExtensions() throws Exception {
            ...
            restWorkflowStore.deletePackage("pkg1", 1, true, true);
        ...
        void deletePackage_cascade_skipsSharedResources() throws Exception {
            ...
            when(WorkflowStore.getPackageDescriptorsContainingResource(eq(sharedUri), eq(false)))
            ...
            when(WorkflowStore.getPackageDescriptorsContainingResource(eq(uniqueUri), eq(false)))
                    .thenReturn(List.of(new DocumentDescriptor()));
        ...
        void deletePackage_cascade_partialFailure() throws Exception {
            ...
            assertDoesNotThrow(() -> restWorkflowStore.deletePackage("pkg1", 1, true, true));
        ...
        void deletePackage_cascade_packageNotFound() throws Exception {
            when(WorkflowStore.read("pkg1", 1))
