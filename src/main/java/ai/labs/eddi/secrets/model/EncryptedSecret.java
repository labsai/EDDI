...
public class EncryptedSecret {
    ...
    public EncryptedSecret(String id, String tenantId, String agentId, String keyName, String encryptedValue, String iv, String dekId,
            String checksum, Instant createdAt, Instant lastAccessedAt) {
        this.id = id;
