...
public class SemanticParserModule {
    ...
    Map<String, Provider<INormalizerProvider>> produceNormalizerProvider(Instance<INormalizerProvider> instance) {
        ...
        map.put(PunctuationNormalizerProvider.ID, () -> instance.select(PunctuationNormalizerProvider.class).get());
        map.put(ConvertSpecialCharacterNormalizerProvider.ID, () -> instance.select(ConvertSpecialCharacterNormalizerProvider.class).get());
        map.put(ContractedWordNormalizerProvider.ID, () -> instance.select(ContractedWordNormalizerProvider.class).get());
        map.put(RemoveUndefinedCharacterNormalizerProvider.ID, () -> instance.select(RemoveUndefinedCharacterNormalizerProvider.class).get());
    ...
    Map<String, Provider<IDictionaryProvider>> produceDictionaryProvider(Instance<IDictionaryProvider> instance) {
        ...
        map.put(IntegerDictionaryProvider.ID, () -> instance.select(IntegerDictionaryProvider.class).get());
        map.put(DecimalDictionaryProvider.ID, () -> instance.select(DecimalDictionaryProvider.class).get());
        map.put(OrdinalNumbersDictionaryProvider.ID, () -> instance.select(OrdinalNumbersDictionaryProvider.class).get());
        map.put(PunctuationDictionaryProvider.ID, () -> instance.select(PunctuationDictionaryProvider.class).get());
        map.put(TimeExpressionDictionaryProvider.ID, () -> instance.select(TimeExpressionDictionaryProvider.class).get());
        map.put(EmailDictionaryProvider.ID, () -> instance.select(EmailDictionaryProvider.class).get());
        map.put(RegularDictionaryProvider.ID, () -> instance.select(RegularDictionaryProvider.class).get());
    ...
    Map<String, Provider<ICorrectionProvider>> produceCorrectionsProvider(Instance<ICorrectionProvider> instance) {
        ...
        map.put(DamerauLevenshteinCorrectionProvider.ID, () -> instance.select(DamerauLevenshteinCorrectionProvider.class).get());
        map.put(PhoneticCorrectionProvider.ID, () -> instance.select(PhoneticCorrectionProvider.class).get());
        map.put(MergedTermsCorrectionProvider.ID, () -> instance.select(MergedTermsCorrectionProvider.class).get());
