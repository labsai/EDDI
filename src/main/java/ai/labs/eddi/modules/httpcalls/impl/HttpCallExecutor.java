 ...
 * Extracted from HttpCallsTask to enable reuse in AI agent tools.
 */
@ApplicationScoped
public class HttpCallExecutor implements IHttpCallExecutor {
    ...
    private static final Logger LOGGER = Logger.getLogger(HttpCallExecutor.class);
                        ...
                        if (isResponseSuccessful && call.getSaveResponse()) {
                            ...
                            if (CONTENT_TYPE_APPLICATION_JSON.startsWith(actualContentType)) {
                                ...
                                if (!actualContentType.startsWith("<not-present>") &&
                                    ...
                                    var message = "HttpCall (%s) didn't return application/json, text/plain nor text/html " +
