...
public class RegularDictionaryStore extends AbstractResourceStore<RegularDictionaryConfiguration>
    ...
    @Override
    public IResourceStore.IResourceId create(RegularDictionaryConfiguration regularDictionaryConfiguration)
    ...
    @Override
    @ConfigurationUpdate
    public Integer update(String id, Integer version, RegularDictionaryConfiguration regularDictionaryConfiguration)
    ...
    @Override
    public RegularDictionaryConfiguration read(String id, Integer version, String filter, String order, Integer index,
        ...
        RegularDictionaryConfiguration regularDictionary = read(id, version);
    ...
    private static class WordComparator implements Comparator<RegularDictionaryConfiguration.WordConfiguration> {
        @Override
        public int compare(RegularDictionaryConfiguration.WordConfiguration word1,
                RegularDictionaryConfiguration.WordConfiguration word2) {
    ...
    private static class PhraseComparator implements Comparator<RegularDictionaryConfiguration.PhraseConfiguration> {
        @Override
        public int compare(RegularDictionaryConfiguration.PhraseConfiguration phrase1,
                RegularDictionaryConfiguration.PhraseConfiguration phrase2) {
