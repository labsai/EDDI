...
public interface IRestAgentStore extends IRestVersionInfo {
        ...
        List<DocumentDescriptor> readAgentDescriptors(
        ...
        Response duplicateAgent(@PathParam("id") String id,
        ...
        Response deleteAgent(@PathParam("id") String id,
                        @Parameter(name = "version", required = true, example = "1", description = "Version of the Agent to delete.") @QueryParam("version") Integer version,
