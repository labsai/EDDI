...
public class WorkflowStore extends AbstractResourceStore<WorkflowConfiguration> implements IWorkflowStore {
    public static final String PACKAGE_EXTENSIONS_FIELD = "WorkflowSteps";
    public static final String PACKAGE_EXTENSIONS_CONFIG_URI_FIELD = "WorkflowSteps.config.uri";
    public static final String PACKAGE_EXTENSIONS_DICTIONARIES_CONFIG_URI_FIELD =
            "WorkflowSteps.extensions.dictionaries.config.uri";
