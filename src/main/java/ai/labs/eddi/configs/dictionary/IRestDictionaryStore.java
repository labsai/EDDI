...
public interface IRestDictionaryStore extends IRestVersionInfo {
    ...
    List<DocumentDescriptor> readRegularDictionaryDescriptors(@QueryParam("filter")
    ...
    Response createRegularDictionary(DictionaryConfiguration regularDictionaryConfiguration);
