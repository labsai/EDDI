...
@Path("/PipelineStore/packages")
@Tag(name = "06. Packages", description = "packages for bots")
public interface IRestPipelineStore extends IRestVersionInfo {
        String resourceURI = "eddi://ai.labs.package/PipelineStore/packages/";
        ...
        PipelineConfiguration readPackage(@PathParam("id") String id,
        ...
        Response createPackage(PipelineConfiguration PipelineConfiguration);
