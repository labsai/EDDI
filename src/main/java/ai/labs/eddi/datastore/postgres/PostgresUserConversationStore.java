...
public class PostgresUserConversationStore implements IUserConversationStore {
    ...
    @Inject
    public PostgresUserConversationStore(DataSource dataSource,
    ...
    public void createUserConversation(UserConversation userConversation)
        ...
        UserConversation existing = readUserConversation(
                userConversation.getIntent(), userConversation.getUserId());
        if (existing != null) {
            throw new IResourceStore.ResourceAlreadyExistsException(
                    String.format("UserConversation with intent=%s does already exist",
                            userConversation.getIntent()));
        }
