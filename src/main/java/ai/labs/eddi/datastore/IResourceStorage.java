...
public interface IResourceStorage<T> {
     ...
     * Used by BotStore/PackageStore for "find configs containing resource" queries.
     *
     * @param jsonPath the JSON field/array path (e.g. "packages", "packageExtensions.config.uri")
