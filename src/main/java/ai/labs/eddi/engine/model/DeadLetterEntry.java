 ...
 *
 * @param id
 *            unique identifier (NATS sequence number or in-memory index)
 ...
 */
public record DeadLetterEntry(String id, String conversationId, String error, long timestamp, String payload) {
}
