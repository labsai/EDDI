...
public interface IRestAgentManagement {
        ...
        void loadConversationMemory(@PathParam("intent") String intent,
                        ...
                        @Parameter(name = "returnDetailed", example = "false") @QueryParam("returnDetailed") @DefaultValue("false") Boolean returnDetailed,
                        @Parameter(name = "returnCurrentStepOnly", example = "true") @QueryParam("returnCurrentStepOnly") @DefaultValue("true") Boolean returnCurrentStepOnly,
