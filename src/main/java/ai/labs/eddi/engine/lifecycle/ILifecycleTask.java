 ...
 * <li><strong>Semantic Parsing</strong>: Extract entities and intents using
 * dictionaries</li>
 * <li><strong>Behavior Rules</strong>: Evaluate IF-THEN rules to decide
 * actions</li>
...
public interface ILifecycleTask {
     ...
     *
     * <p>
     * The type is used by the LifecycleManager to determine execution order and
     * filter tasks when partial lifecycle execution is needed.
     * </p>
     *
     ...
     * <li>Perform their specific processing (parsing, rule evaluation, API calls,
     * etc.)</li>
     ...
     * <li>Return a component object used during
     * {@link #execute(IConversationMemory, Object)}</li>
     * </ul>
     *
     * <p>
     * <strong>Example:</strong>
