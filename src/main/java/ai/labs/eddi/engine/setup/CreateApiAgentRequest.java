...
/**
 * Request object for creating an API Agent from an OpenAPI spec.
 * Maps to the MCP {@code create_api_agent} tool parameters and the
 * REST {@code POST /administration/agents/setup-api} endpoint body.
 *
 * @author ginccc
 */
