...
/**
 * Request object for setting up a standard Agent.
 * Maps to the MCP {@code setup_agent} tool parameters and the
 * REST {@code POST /administration/agents/setup} endpoint body.
 *
 * @author ginccc
 */
