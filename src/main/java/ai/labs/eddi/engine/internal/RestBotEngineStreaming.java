 ...
 */
@ApplicationScoped
public class RestBotEngineStreaming implements IRestBotEngineStreaming {

    private static final Logger LOGGER = Logger.getLogger(RestBotEngineStreaming.class);

    private final IConversationService conversationService;

    @Inject
    public RestBotEngineStreaming(IConversationService conversationService) {
    ...
    public void sayStreaming(Environment environment, String botId, String conversationId,
        ...
        try {
            conversationService.sayStreaming(
                    environment, botId, conversationId,
