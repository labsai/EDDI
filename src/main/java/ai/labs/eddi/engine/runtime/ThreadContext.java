...
public abstract class ThreadContext {
    ...
    /**
     * Returns the ThreadLocal Map. This Map is used internally to bind objects to
     * the current thread by storing each object under a unique key.
     *
     ...
     * <p/>
     * <p>
     * A <tt>null</tt> <tt>value</tt> has the same effect as if <tt>remove</tt> was
     * called for the given <tt>key</tt>, i.e.:
     * <p/>
     *
     * <pre>
     * if (value == null) {
     ...
     * <p/>
     * This method is meant to be the final 'clean up' operation that is called at
     * the end of thread execution to prevent thread corruption in pooled thread
     * environments.
     *
     * @since 1.0
     */
     ...
     * <p/>
     * <p>
     * The method's existence is to help reduce casting in your own code and to
     * simplify remembering of ThreadContext key names. The implementation is simple
     * in that, if the Subject is not <tt>null</tt>, it binds it to the thread,
     * i.e.:
     * <p/>
     *
     * <pre>
     ...
     *
     * @param subject
     *            the Subject object to bind to the thread. If the argument is null,
