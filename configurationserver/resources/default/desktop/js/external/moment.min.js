...
(function (a, b) {
    ...
    function X(a, b) {
        var c = [0, 0, 1, 0, 0, 0, 0], d = {tzh:0, tzm:0}, e = b.match(l), f, g;
    ...
    }}), c.fn = G.prototype = {clone:function () {
        return c(this)
    }, valueOf:function () {
        return+this._d
    }, unix:function () {
    ...
    ab("year", "FullYear"), c.duration.fn = H.prototype = {weeks:function () {
