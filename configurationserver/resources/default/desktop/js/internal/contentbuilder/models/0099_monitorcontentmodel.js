    ...
    this.makeContentModel = function (sizeCallbackInstance, selectionCallbackInstance) {
        ...
        for (var i = 0; i < conversationLog.conversationSteps.length; i++) {
            ...
            for (var j = 0; j < packagesArray.length; j++) {
                ...
                packageData.push([ '<img class="dataTables_dotbutton" src="/binary/default/desktop/images/dotbutton.png"/>', name, duration, count ]);
            }
            ...
            conversationStepData.push([ '<img class="dataTables_dotbutton" src="/binary/default/desktop/images/dotbutton.png"/>', date, input, output ]);
        }
