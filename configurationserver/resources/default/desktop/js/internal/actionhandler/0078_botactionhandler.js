function BotActionHandler(contentBuilder, dataProvider) {
    ...
    this.observer = new Observer(function (event) {
        switch (event.command) {
            ...
            case 'LinkBot':
                window.open(
                    uiEngineServer + '/ui/restricted/' + application.dataProvider.dataProviderState.getActiveId(),
                    '_blank' // <- This is what makes it open in a new window.
                );
                break;
            case 'LinkBotTest':
                window.open(
                    uiEngineServer + '/ui/test/' + application.dataProvider.dataProviderState.getActiveId(),
                    '_blank' // <- This is what makes it open in a new window.
                );
                break;
            case 'VersionChanged':
