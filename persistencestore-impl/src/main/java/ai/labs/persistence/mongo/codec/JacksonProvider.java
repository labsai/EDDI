 ...
 */
package ai.labs.persistence.mongo.codec;
...
public class JacksonProvider implements CodecProvider {
    private final ObjectMapper bsonObjectMapper;

    public JacksonProvider(final ObjectMapper bsonObjectMapper) {
