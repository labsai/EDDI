...
public class RepositoryModule extends AbstractBaseModule {
    ...
    protected void configure() {
        ...
        bind(IRestPackageExtensionStore.class).to(RestPackageExtensionStore.class).in(Scopes.SINGLETON);
        ...
        bind(IRestP2PStore.class).to(RestP2PStore.class).in(Scopes.SINGLETON);
    }
}
