...
| 5   | `LangchainTask`               | `ai.labs.llm`             | `langchain`      | [LangchainTask.java](file:///c:/dev/git/EDDI/src/main/java/ai/labs/eddi/modules/langchain/impl/LangchainTask.java)                            | 583   | LLM chat (legacy mode) or agent loop (with tools)         |
