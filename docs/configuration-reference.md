...
| `eddi.backup.import.max-entry-bytes` | `67108864` (64 MiB) | Most bytes one archive entry may inflate to, counted from what is actually decompressed rather than from the entry header |
