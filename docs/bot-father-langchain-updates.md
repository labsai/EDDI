# Agent Father LangChain Task Feature Updates
...
All LLM provider connector agents now support three new configuration options:
...
The following connector agent providers have been updated:
...
When creating a new connector agent, users will now see:
...
- All changes are additive - existing agent configurations continue to work
...
1. Test creating a new OpenAI agent with tools enabled
2. Test creating a new Anthropic agent without tools
...
- [Agent Father Deep Dive](docs/agent-father-deep-dive.md)
