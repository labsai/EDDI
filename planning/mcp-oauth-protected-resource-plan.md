...
**Status:** Increments 1 and 2 implemented by the PR stack this plan ships with (see the 2026-09-20 changelog entries). The optional DCR phase is not started, and the open questions below still stand.
