function DependencyModel(extension) {
    this.makeDefaultJSON = function () {
        return {
            id: application.dataProvider.getNextIdForBehaviorRuleExtension(),
            values: {
                reference: application.dataProvider.getDefaultDependencyReference()
            },
            selected: false,
            children: [],
            type: "dependency"
    ...
    this.idPrefix = "dependency_";
    this.CSSClassBase = "dependency_control";
    this.selected = extension.selected;
    this.reference = extension.values.reference;
