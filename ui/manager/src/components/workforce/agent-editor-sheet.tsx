...
function AgentEditorSheet({ agentId, onClose }: AgentEditorSheetProps) {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      toast.error(
        t("Workforce.agentEditor.saveError", "Failed to save changes")
      );
    } finally {
      setSaving(false);
  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal={true}
        aria-label={t("Workforce.agentEditor.title", "Edit Agent")}
      >
        {/* ── Header ──────────────────────────────────────── */}
          ...
          {isError && (
            <div className="p-8 text-center space-y-4">
              <p className="text-sm text-muted-foreground">
                {t(
                  "Workforce.agentEditor.loadError",
              ...
              >
                ...
                {t("Workforce.agentEditor.retry", "Retry")}
              </Button>
            </div>
          )}
          ...
          {!isLoading && !isError && agent && (
            <div className="p-6 space-y-6">
              ...
              <section>
                ...
                >
                  {t("Workforce.agentEditor.description", "Description")}
                </label>
                <textarea
                  ref={textareaRef}
                  ...
                  rows={3}
                  placeholder={t(
                    "Workforce.agentEditor.descriptionPlaceholder",
              ...
              <section>
                ...
                >
                  ...
                  {t("Workforce.agentEditor.systemPrompt", "System Prompt")}
                </label>
                {promptLoading ? (
                  <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={6}
                    placeholder={t(
                      "Workforce.agentEditor.systemPromptPlaceholder",
              ...
              <section>
                ...
                {capabilities.length === 0 && !addingCapability && (
                  <p className="text-sm text-muted-foreground mb-2">
                    {t(
                      "Workforce.agentEditor.noCapabilities",
                  ...
                  {capabilities.map((cap, idx) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        aria-label={t(
                          "Workforce.agentEditor.removeCapability",
                          "Remove capability"
                        )}
                      >
                        <X className="h-3 w-3" />
                ...
                {addingCapability ? (
                  <div className="flex items-end gap-2 p-3 rounded-lg border border-border bg-card">
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        {t("Workforce.agentEditor.skill", "Skill")}
                      </label>
                      <input
                        id="new-skill"
                        type="text"
                        ...
                        placeholder={t(
                          "Workforce.agentEditor.skillPlaceholder",
                          "e.g. summarization"
                        )}
                        value={newSkill}
                    ...
                    <div>
                      <label
                        ...
                        className="block text-xs font-medium text-muted-foreground mb-1"
                      >
                        {t("Workforce.agentEditor.confidence", "Confidence")}
                      </label>
                      <select
                        id="new-confidence"
                        className={cn(
                      ...
                      >
                        <option value="low">{t("Workforce.agentEditor.confidenceLow", "Low")}</option>
                        <option value="medium">{t("Workforce.agentEditor.confidenceMedium", "Medium")}</option>
                        <option value="high">{t("Workforce.agentEditor.confidenceHigh", "High")}</option>
                      </select>
                    </div>
                    <Button
                      variant="primary"
                    ...
                    >
                      {t("Workforce.agentEditor.add", "Add")}
                    </Button>
                  </div>
                ) : (
                  <Button
                  ...
                  >
                    ...
                    {t(
                      "Workforce.agentEditor.addCapability",
                      "Add Capability"
                    )}
                  </Button>
                )}
              ...
              <section>
                <h3 className="text-sm font-medium text-foreground mb-3">
                  {t("Workforce.agentEditor.settings", "Settings")}
                </h3>
                <div className="space-y-2">
                  {/* a2aEnabled toggle */}
                  <button
                    ...
                    aria-label={t("Workforce.agentEditor.a2aEnabled", "Agent-to-Agent Communication")}
                  >
                  ...
                  <button
                    ...
                    aria-label={t("Workforce.agentEditor.memoryTools", "Memory Tools")}
                  >
                    <span className="text-sm text-foreground">
                      {t(
                        "Workforce.agentEditor.memoryTools",
                        "Memory Tools"
                      )}
                    </span>
                    <div
