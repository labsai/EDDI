...
const STORAGE_KEY = "workforce-sidebar-collapsed";
...
export function WorkforceLayout() {
  ...
  if (viewport === "mobile") {
    return (
      <div data-testid="workforce-layout" className="Workforce relative flex h-screen flex-col overflow-hidden">
        <WorkforceShortcuts />
        <ShortcutsDialog />
        <a
          href="#workforce-main"
        ...
        >
          {t("Workforce.skipToContent", "Skip to content")}
        </a>
        <WorkforceTopbar />
        <main
          id="workforce-main"
  ...
  if (viewport === "tablet") {
    return (
      <div data-testid="workforce-layout" className="Workforce relative flex h-screen flex-col overflow-hidden">
        ...
        <WorkforceTopbar onMenuClick={openDrawer} />
        ...
        {drawerOpen && (
          <>
            ...
            <div
              ...
              role="dialog"
              aria-modal="true"
              aria-label={t("Workforce.sidebarDrawer", "Sidebar navigation")}
  ...
  // ─── Desktop ─────────────────────────────────────────────────
  return (
    <div data-testid="workforce-layout" className="Workforce relative flex h-screen overflow-hidden">
      <WorkforceShortcuts />
      <ShortcutsDialog />
      <a
        href="#workforce-main"
      ...
      <WorkforceSidebar collapsed={collapsed} onToggle={toggleCollapsed} />
