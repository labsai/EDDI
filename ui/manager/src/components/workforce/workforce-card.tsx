  ...
  function handleDuplicate() {
    duplicateGroup.mutate(
      { id, version: currentVersion },
      {
        onSuccess: (data) => {
          ...
          if (newId && newId.length > 0) {
            toast.success(
              ...
              {
                action: {
                  label: t("Workforce.card.openSettings", "Open Settings"),
        ...
        onError: () =>
          toast.error(
            t("Workforce.dashboard.duplicateError", "Failed to duplicate task force"),
          ),
      },
    );
  }
  ...
  function handleDelete() {
    deleteGroup.mutate(
      { id, version: currentVersion, permanent: true },
      {
        ...
        onError: () =>
          toast.error(
            t("Workforce.dashboard.deleteError", "Failed to delete task force"),
          ),
      },
    );
  }
          ...
          <>
            ...
            <div className="flex items-start gap-2">
              ...
              <h3 className="min-w-0 flex-1 text-base font-semibold text-foreground line-clamp-1">
                {name || t("Workforce.card.untitled", "Untitled Task Force")}
              </h3>
              ...
              {onTogglePin && (
                <button
                  ...
                  aria-label={isPinned ? t("Workforce.card.unpin", "Unpin") : t("Workforce.card.pin", "Pin")}
                >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    ...
                    aria-label={t("Workforce.card.moreActions", "More actions")}
                    data-testid={`workforce-menu-${id}`}
                  >
                ...
                <DropdownMenuContent align="end" className="w-48" onClick={(e) => {
                  ...
                  >
                    ...
                    {t("Workforce.card.settings", "Settings")}
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    ...
                    {t("Workforce.card.history", "History")}
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    ...
                    {t("Workforce.card.duplicate", "Duplicate")}
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem
                  ...
                  >
                    ...
                    {t("Workforce.card.delete", "Delete")}
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
              </div>
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {members.length > 0 ? (
                  ...
                  <span className="text-xs text-muted-foreground">
                    {t("Workforce.card.noMembers", "No experts")}
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center gap-3 text-xs text-muted-foreground">
                <span>
                  {t("Workforce.card.advisorCount", "{{count}} experts", {
...
export { WorkforceCard };
export type { WorkforceCardProps };
