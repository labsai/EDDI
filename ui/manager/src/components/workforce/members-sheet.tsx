      ...
      <div className="flex items-center justify-between ps-4 pe-4 py-3 border-b border-border">
        <div className="flex items-center gap-2">
          <h3 className="text-sm font-semibold text-foreground">
            {t("Workforce.board.members", "Team")}
          </h3>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  {isModerator && (
                    <span
                      className="text-xs"
                      title={t("Workforce.board.moderator", "Moderator")}
                      role="img"
                      aria-label={t("Workforce.board.moderator", "Moderator")}
                    >
                      ⭐
                    </span>
                  )}
              ...
              >
                <Link to={`/workforce/${boardId}/thread/${member.agentId}`}>
                  {t("Workforce.board.chatOneOnOne", "Chat 1:1")}
                </Link>
              </Button>
            </li>
          );
        ...
        {members.length === 0 && (
          <div className="p-8 text-center">
            <p className="text-sm text-muted-foreground">
              {t("Workforce.board.noMembers", "No team members")}
            </p>
          </div>
        )}
      </div>
