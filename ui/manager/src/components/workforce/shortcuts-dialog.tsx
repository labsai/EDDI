...
export function ShortcutsDialog() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("workforce:show-shortcuts", handler);
  }, []);
  ...
  const shortcuts = [
    {
      key: "N",
      label: t("Workforce.shortcuts.newBoard", "Assemble Task Force"),
      context: t("Workforce.shortcuts.fromDashboard", "From dashboard"),
    },
    {
      key: "?",
      label: t("Workforce.shortcuts.showHelp", "Show keyboard shortcuts"),
    },
    {
      key: "Esc",
      label: t("Workforce.shortcuts.closePanel", "Close panel / dialog"),
    },
  ];
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={t("Workforce.shortcuts.title", "Keyboard Shortcuts")}
        ...
        >
          <div className="flex items-center justify-between ps-5 pe-5 pt-4 pb-3 border-b border-border">
            <h2 className="text-lg font-semibold">
              {t("Workforce.shortcuts.title", "Keyboard Shortcuts")}
            </h2>
            <button
              ref={closeRef}
              onClick={() => setOpen(false)}
              ...
              aria-label={t("Workforce.board.close", "Close")}
            >
              ✕
            </button>
          </div>
