    ...
    <div className="relative flex h-full min-h-0 min-w-0 flex-col rounded-xl border border-border" {...dropHandlers}>
      ...
      >
        ...
        {/* The approved step is running, and it is NOT streamed — resolveApproval
            ...
            Rendered AFTER the approval block, not between the transcript and
            it: the row narrates what happens as a consequence of the decision
            just made, so it belongs where the eye lands after clicking Approve
            — below the card, at the bottom of the flow — not above the very
            card whose buttons it is the effect of. */}
        {isResolvingPause && (
          <div
            className="flex items-center gap-2 px-4 py-1 text-[11px] text-muted-foreground"
