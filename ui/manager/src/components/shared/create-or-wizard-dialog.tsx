      ...
      <div className="p-5">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <button
            ...
            className="group flex flex-col items-start gap-3 rounded-xl border-2 border-border bg-card p-5 text-start transition-all hover:border-primary/50 hover:shadow-md"
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-500/10 text-amber-500 transition-colors group-hover:bg-amber-500/20">
