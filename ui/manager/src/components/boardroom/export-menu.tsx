    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          aria-label={t("boardroom.export.title", "Export discussion")}
        >
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={handleMarkdown}>
          ...
          {t("boardroom.export.markdown", "Export as Markdown")}
        </DropdownMenuItem>
        <DropdownMenuItem onClick={handleJson}>
          <Braces className="h-4 w-4 me-2" />
          {t("boardroom.export.json", "Export as JSON")}
        </DropdownMenuItem>
        <DropdownMenuItem onClick={handleCopy}>
          <Copy className="h-4 w-4 me-2" />
          {t("boardroom.export.clipboard", "Copy to Clipboard")}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
