      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-border/50">
          <span className="text-xs text-muted-foreground">
            {t("boardroom.onboarding.advisorSlots", "{{count}} advisor slots", {
          ...
          <span className="text-xs font-medium text-primary opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
            {t("boardroom.onboarding.getStarted", "Get started")}
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-medium">
        {t("boardroom.onboarding.customFromScratch", "Build from Scratch")}
      </span>
      <span className="text-xs text-muted-foreground mt-1">
        {t(
          "boardroom.onboarding.customDesc",
    ...
    >
      ...
      <div className="flex-1 text-center sm:text-start">
        <p className="text-sm font-semibold text-foreground">
          {t(
            "boardroom.onboarding.deployFirst",
            "Deploy your first AI agent to get started",
          )}
        </p>
        <p className="text-xs text-muted-foreground mt-0.5">
          {t(
            "boardroom.onboarding.deployFirstDesc",
...
function OnboardingHero() {
  ...
  return (
    <div className="p-5 md:p-8 max-w-5xl ms-auto me-auto space-y-10">
      ...
      {/* ── How It Works ────────────────────────────────────────── */}
      <section
        aria-label={t("boardroom.onboarding.howItWorks", "How it works")}
        className="space-y-4"
      >
        <h2
        ...
        >
          {t("boardroom.onboarding.howItWorks", "How it works")}
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <HowItWorksStep
            step={1}
            icon={<Bot className="h-6 w-6" />}
            title={t("boardroom.onboarding.step1Title", "Deploy Agents")}
            description={t(
            ...
            action={
              !hasAgents ? (
                ...
                <span className="inline-flex items-center gap-1.5 text-xs text-primary">
                  ...
                  {t("boardroom.onboarding.agentsReady", "{{count}} ready", {
                    count: agents.length,
                  })}
                </span>
              )
          ...
          <HowItWorksStep
            ...
            title={t(
              "boardroom.onboarding.step2Title",
          ...
          <HowItWorksStep
            ...
            title={t(
              "boardroom.onboarding.step3Title",
              "Ask & Watch",
            )}
            description={t(
      ...
      <section
        aria-label={t(
          "boardroom.onboarding.pickTemplate",
      ...
      >
        <div className="text-center br-section-enter" style={{ "--enter-delay": "200ms" } as React.CSSProperties}>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {t(
              "boardroom.onboarding.pickTemplateDesc",
