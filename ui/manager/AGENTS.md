...
**Phase 5+**: Phases 5–6 (NATS JetStream, PostgreSQL/DB-agnostic) ✅ complete. Quick wins next: quarkus-langchain4j→core (6E), Lombok removal (6D). Then: Secrets+Audit+Tenancy (7), MCP Servers (8a), MCP Client+RAG (8b), DAG+OTel (9), HITL (9b), Multi-Bot (10a), Advanced RAG+Debate (10b), Persistent Memory+Heartbeat (11), CI/CD (12), **Advanced Manager UI — Debugger, Visual Pipeline, Taint Tracking (13)**, Website Astro (14). See EDDI [`AGENTS.md`](../EDDI/AGENTS.md) and [`project-philosophy.md`](../EDDI/docs/project-philosophy.md) for full roadmap and principles.
