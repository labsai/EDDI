...
/*    @Test
    ...
    private void createInputMatcherDummy() {
        IExtensionDescriptor descriptor = ExtensionDescriptorBuilder.create("inputmatcher", "", "io.sls.core.behavior.extensions.InputMatcher").attribute("expressions", "List<Expression>", "").build();
    ...
    private void createOccurenceDummy() {
        IExtensionDescriptor descriptor = ExtensionDescriptorBuilder.create("occurrence", "", "io.sls.core.behavior.extensions.Occurrence").build();
        BehaviorRuleExtensionRegistry.getInstance().register(descriptor.getId(), descriptor);
    }
}
